...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `starfe`(Name, email, password, type) VALUES('$name', '$email', '$pass', '$type')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="checkbox" id="bp" name="ptype" value="f_manager">
      <label for="fmanager"> ficancial maneger</label><br>
      <input type="checkbox" id="bp" name="ptype" value="rq-manager">
